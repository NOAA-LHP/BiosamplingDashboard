...
![Available age, growth, reproductive maturity, and natural mortality information for BMUS in Guam.](~/Documents/github/BiosamplingDashboard/dashboard/www/media/Guam_safeLH.png){width="800"}

<br>

![Available age, growth, reproductive maturity, and natural mortality information for BMUS in CNMI.](~/Documents/github/BiosamplingDashboard/dashboard/www/media/CNMI_safeLH.png){width="800"}

<br>

![](~/Documents/github/BiosamplingDashboard/dashboard/www/media/gindai.jpg){width="200"} **Gindai (*Pristipomoides zonatus*)**
...
![](~/Documents/github/BiosamplingDashboard/dashboard/www/media/VALO_2_together.png){width="200"} **Yellow-Edged Lyretail (*Variola louti*)**
...
![](~/Documents/github/BiosamplingDashboard/dashboard/www/media/PRAU_photo.png){width="200"} **Yellowtail Kalekale, Goldenflag Snapper (*Pristipomoides auricilla*)**
...
![Available age, growth, reproductive maturity, and natural mortality information for BMUS in American Samoa.](~/Documents/github/BiosamplingDashboard/dashboard/www/media/ASamoa_safeLH.png){width="800"}

<br>

**Hawaiʻi**

![Available age, growth, reproductive maturity, and natural mortality information for BMUS in Hawaii.](~/Documents/github/BiosamplingDashboard/dashboard/www/media/Hawaii_safeLH.png){width="800"}

<br>

![](~/Documents/github/BiosamplingDashboard/dashboard/www/media/PRFI.png){width="200"} **ʻŌpakapaka (*Pristipomoides filamentosus*)**
...
![](~/Documents/github/BiosamplingDashboard/dashboard/www/media/onaga_gonad.jpeg){width="200"} **Onaga (*Etelis coruscans*)**
