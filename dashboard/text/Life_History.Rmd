...
![Available age, growth, reproductive maturity, and natural mortality information for BMUS in Guam.](media/Guam_safeLH.png){width="800"}

<br>

![Available age, growth, reproductive maturity, and natural mortality information for BMUS in CNMI.](media/CNMI_safeLH.png){width="800"}

<br>

![](media/gindai.jpg){width="200"} **Gindai (*Pristipomoides zonatus*)**
...
![](media/VALO_2_together.png){width="200"} **Yellow-Edged Lyretail (*Variola louti*)**
...
![](media/PRAU_photo.png){width="200"} **Yellowtail Kalekale, Goldenflag Snapper (*Pristipomoides auricilla*)**
...
![Available age, growth, reproductive maturity, and natural mortality information for BMUS in American Samoa.](media/ASamoa_safeLH.png){width="800"}

<br>

**Hawaiʻi**

![Available age, growth, reproductive maturity, and natural mortality information for BMUS in Hawaii.](media/Hawaii_safeLH.png){width="800"}

<br>

![](media/PRFI.png){width="200"} **ʻŌpakapaka (*Pristipomoides filamentosus*)**
...
![](media/onaga_gonad.jpeg){width="200"} **Onaga (*Etelis coruscans*)**
